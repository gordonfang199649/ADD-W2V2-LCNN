...
def train(args):
    ...
    # 加載三個主要數據集
    training_sets = {
        "DFADD": RawAudio(path_to_features='./preprocess_xls-r_DFADD/xls-r',
                        path_to_meta='../datasets/DFADD', meta_file='meta.csv', pad_chop=False, part='train'),
        "CodecFake": RawAudio(path_to_features='./preprocess_xls-r_CodecFake/xls-r',
                            path_to_meta='../datasets/CodecFake', meta_file='meta.csv', pad_chop=False, part='train'),
        "ASVspoof2021_DF": RawAudio(path_to_features='./preprocess_xls-r_ASVspoof2021_DF/xls-r',
                            path_to_meta='../datasets/ASVspoof2021_DF', meta_file='meta.csv', pad_chop=False, part='train')
    }
    ...
    # 加載 LibriSpeech 數據集
    librispeech_set = RawAudio(path_to_features='./preprocess_xls-r_LibriSpeech/xls-r',
                            path_to_meta='../datasets/LibriSpeech', meta_file='meta.csv', pad_chop=False, part='train')
    ...
    # 創建 DataLoader
    trainOriDataLoader = DataLoader(final_training_set, batch_size=int(args.batch_size),
                                    shuffle=True, num_workers=args.num_workers)
    trainOri_flow = iter(trainOriDataLoader)

    # 驗證集處理
    validation_set_list = [
        RawAudio(path_to_features='./preprocess_xls-r_DFADD/xls-r',
                        path_to_meta='../datasets/DFADD', meta_file='meta.csv', pad_chop=False, part='validation'),
        RawAudio(path_to_features='./preprocess_xls-r_CodecFake/xls-r',
                            path_to_meta='../datasets/CodecFake', meta_file='meta.csv', pad_chop=False, part='validation'),
        RawAudio(path_to_features='./preprocess_xls-r_ASVspoof2021_DF/xls-r',
                            path_to_meta='../datasets/ASVspoof2021_DF', meta_file='meta.csv', pad_chop=False, part='validation')
    ]
    # 合併所有數據集
