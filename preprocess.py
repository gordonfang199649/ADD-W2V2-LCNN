...
for part_ in ["train","dev","eval"]:
    asvspoof_raw = dataset.ASVspoof2019Raw("LA", "./LA",
                                        "./LA/ASVspoof2019_LA_cm_protocols", part=part_)
    waveform, file, tag, label = asvspoof_raw[0]
    print(waveform.shape, file, label)
    # target_dir = os.path.join("./preprocess_xls-r", part_,
    #                           "xls-r")
